...
CREATE TABLE `ref_country` (
  ...
  `country_abr` varchar(4) COLLATE utf8_unicode_ci DEFAULT NULL,
...
INSERT INTO `ref_country` VALUES (1,'Lebanon','LBN','961'),(2,'Greece','GRE','335'),(3,'Syria','Syr','999'),(4,'France','Fr','785');
